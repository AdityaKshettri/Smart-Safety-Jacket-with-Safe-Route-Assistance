...
AutocompleteDirectionsHandler.prototype.route = function() {
    ...
    function(response, status) 
    {
        ...
        {
            var image1 = {
                url: '../img/sign/extremeDanger.png',
                scaledSize: new google.maps.Size(28, 28),
            };
            var image2 = {
                url: '../img/sign/danger.jpg',
                scaledSize: new google.maps.Size(28, 28),
            };
            var image3 = {
                url: '../img/sign/avoid.png',
                scaledSize: new google.maps.Size(23, 23),
            };
            var image4 = {
                url: '../img/sign/safe.png',
                scaledSize: new google.maps.Size(23, 23),
            };
            var image5 = {
                url: '../img/sign/safest.png',
                scaledSize: new google.maps.Size(23, 23),
            };
            ...
            for (var k = 0, len = response.routes.length; k < len; k++) 
            {
                ...
                var route = "route"+k;
                var colour = "color"+k;
                var duration = "duration"+k;
                var distance = "distance"+k;
                var safetyi = "safetyi"+k;
                div.innerHTML = '<ul class="msg"><li id='+route+'></li><li id='+colour+'></li><li id='+duration+'></li><li id='+distance+'></li><li id='+safetyi+'></li></ul>';
                document.getElementById(route).innerHTML = "<hr>Route Number: #" + k;
                document.getElementById(colour).innerHTML = "Colour : " + color[k] + ' <img height="20" width="20" src="../img/colour/' + color[k] + '.jpg" />';
                ...
                document.getElementById(safetyi).innerHTML = 'DangerIndex is : ' + dindex[k] + '<hr>';
            }

            var div = document.createElement('div');
            document.body.appendChild(div);
            div.style = 'background-color: black; color:white; text-align: center;font-family: "Times New Roman", Times, serif;';
            div.innerHTML = '<hr><hr><h3><p>The Safest Route is : ' + '<img height="28" width="28" src="../img/colour/' + color[pos] + '.jpg" /> #' + pos + '</p></h3><h4><p>(Danger Index : ' + dindex[pos] + ')</p></h4><hr><hr>';
